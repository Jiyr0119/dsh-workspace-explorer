		...
		*/
		...
		const DICTS = {
			...
			en: {
				...
				"lines.tail": "…({n} lines total, showing the first {m})",
		...
		function DrawerRoot(props) {
			...
			(0, react.useEffect)(() => {
				...
				const onDrop = (e) => {
					...
					if ((e.target instanceof HTMLElement ? e.target : null)?.closest("[data-composer-card] textarea")) {
						setDragging(false);
						return;
					}
					e.preventDefault();
