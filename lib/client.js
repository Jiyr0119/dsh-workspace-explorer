window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var panel_module_css_default = {
			...
			"dshwe-resize": "_54xtAa_dshwe-resize",
		...
		*/
		...
		async function fetchTreeText(path, depth = 3) {
			try {
		...
		function DrawerRoot(props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				}) : null, on ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
